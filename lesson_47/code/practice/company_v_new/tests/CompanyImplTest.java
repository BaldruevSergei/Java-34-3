...
import practice.company_v_new.dao.CompanyArrayListImpl;
...
class CompanyImplTest {
    ...
    void setUp() {
        ...
        e = new Employee[4];
        e[0] = new Manager(101, "John", "Smith", 45, 180, 10, "University", 5000, 6);
        e[1] = new SalesManager(102, "Anna", "Black", 30, 160, 6.7, "School", 3000, 4);
        e[2] = new SalesManager(103, "Thomas", "White", 28, 160, 6.7, "College", 2500, 3);
        e[3] = new Worker(104, "Gans", "Bauer", 30, 90, 3, "School", 3);
    ...
    void addEmployee() {
        ...
        Employee employee1 = new Manager(105, "Ivan", "Dubin", 55, 160,6,"University",6000,7); // создали нового сотрудника
        ...
        Employee employee2 = new Manager(106, "Peter", "Dubin", 55, 160,7,"School",4500,5); // создали нового сотрудника
    ...
    void totalSalaryTest() {
        assertEquals(25850, company.totalSalary(), 0.01);
    }

    @Test
    void avgSalaryTest() {
        assertEquals( 25850 / 4, company.avgSalary(), 0.5);
    }

    @Test
    void totalSalesTest() {
        assertEquals(5500, company.totalSales());
    }
    ...
    void findEmployeesSalaryRangeTest(){
        company.printEmployees();
        Employee[] actual = company.findEmployeesSalaryRange(1000, 10000);
