...
class AlbumImplTest {
    ...
    void removePhoto() {
        // удаление
        assertTrue(album.removePhoto(3,1)); // удалили ph  с индексом ph[2]
        // удаление отсуствующего фото
    ...
    @Test
    void updatePhoto() {
        assertTrue(album.updatePhoto(1,1,"newUrl"));// обновили только url
    ...
    void getPhotoFromAlbum() {
        ...
        assertNull(album.getPhotoFromAlbum(3,1)); // ищем несуществующее фото
    }
    ...
    void getAllPhotoFromAlbum() {
        ...
        Photo[] actual = album.getAllPhotoFromAlbum(2); // выбрали второй альбом albumId = 2
